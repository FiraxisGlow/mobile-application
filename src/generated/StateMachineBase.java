...
**/
    ...
    public com.codename1.ui.TextField findTxt(Component root) {
        return (com.codename1.ui.TextField)findByName("txt", root);
    }

    public com.codename1.ui.TextField findTxt() {
        com.codename1.ui.TextField cmp = (com.codename1.ui.TextField)findByName("txt", Display.getInstance().getCurrent());
        if(cmp == null && aboutToShowThisContainer != null) {
            cmp = (com.codename1.ui.TextField)findByName("txt", aboutToShowThisContainer);
        }
        return cmp;
    }
    ...
    protected void handleComponentAction(Component c, ActionEvent event) {
        ...
        if(rootContainerName.equals("Main")) {
            if("txt".equals(c.getName())) {
                onMain_TxtAction(c, event);
                return;
            }
      ...
      protected void onMain_TxtAction(Component c, ActionEvent event) {
      }
